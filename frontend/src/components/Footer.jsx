...
function Footer() {
  return (
    <footer className="bg-neutral text-neutral-content">
      <div className="footer max-w-7xl mx-auto p-10 flex flex-col md:flex-row justify-between items-center md:items-start">
        ...
        <aside className="flex flex-col items-center md:items-start gap-2">
          ...
          />
          <p className="font-bold text-xl">BIKER.IO</p>
        </aside>

        {/* Right Section: Socials */}
        <nav className="flex flex-col items-center md:items-start">
          <h6 className="footer-title opacity-50 uppercase tracking-widest mb-4">Social</h6>
